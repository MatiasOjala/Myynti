...
var vanhaasiakas = requestURLParam("vanhaasiakas"); //Funktio läytyy scripts/main.js 
fetch("asiakkaat/haeyksi/" + vanhaasiakas,{//Lähetetään kutsu backendiin
      method: 'GET'	      
    })
...
.then( function (responseJson) {//Otetaan vastaan objekti responseJson-parametrissä	
	...
	document.getElementById("vanhaasiakas").value = vanhaasiakas;
});	
